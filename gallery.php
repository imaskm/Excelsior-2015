...
<html lang=''>
<head>
<title>Gallery/Excelsior-2015</title>
<link rel="shortcut icon" href="images/nitin.ico" type="image/icon">
  ...
  <script src="jquery-latest.min.js" type="text/javascript"></script>
   ...
   <script src="js/jquery-1.10.2.min.js"></script> 
    ...
    var divextend = document.getElementById("templatemo-hex-top2div");
    if (divextend.style.display !== "none")
    {
      divextend.style.display = "none";
    }
    else {
      divextend.style.display = "block";
    }
...
<ul>
  ...
  <div  id="templatemo-hex-top2div" style="display:none;" class="container answer_list templatemo_gallerytop">
      <div class="row templatemorow">
    ...
    <div class="hex col-sm-6  templatemo-hex-top2">
      <div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(images/gallery/22.jpg);">
                <div class="overlay">
            <a href="images/gallery/22.jpg" data-rel="lightbox" class="fa fa-expand"></a>
          </div>
              </div>
            </div>
          </div>
    ...
    <div class="hex col-sm-6  templatemo-hex-top3">
      <div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(images/gallery/23.jpg);">
                <div class="overlay">
            <a href="images/gallery/23.jpg" data-rel="lightbox" class="fa fa-expand"></a>
          </div>
              </div>
            </div>
          </div>
    ...
    <div class="hex col-sm-6  templatemo-hex-top3">
      <div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(images/gallery/24.jpg);">
                  <div class="overlay">
            <a href="images/gallery/24.jpg" data-rel="lightbox" class="fa fa-expand"></a>
          </div>
              </div>
            </div>
          </div>
 ...
 <div class="hex col-sm-6 hex-offset templatemo-hex-top1 templatemo-hex-top2">
      <div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(images/gallery/25.jpg);">
                  <div class="overlay">
            <a href="images/gallery/25.jpg" data-rel="lightbox"   class="fa fa-expand"></a>
          </div>
              </div>
            </div>
          </div>
     ...
     <div class="hex col-sm-6 templatemo-hex-top1 templatemo-hex-top3">
      <div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(images/gallery/26.jpg);">
                  <div class="overlay">
            <a href="images/gallery/26.jpg" data-rel="lightbox" class="fa fa-expand"></a>
          </div>
              </div>
            </div>
          </div>
      ...
      <div class="hex col-sm-6 templatemo-hex-top1  templatemo-hex-top3">
        <div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(images/gallery/27.jpg);">
                  <div class="overlay">
            <a href="images/gallery/27.jpg" data-rel="lightbox" class="fa fa-expand"></a>
          </div>
              </div>
            </div>
          </div>
      ...
      <div class="hex col-sm-6 templatemo-hex-top1  templatemo-hex-top2">
        <div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(images/gallery/28.jpg);">
                  <div class="overlay">
            <a href="images/gallery/28.jpg" data-rel="lightbox" class="fa fa-expand"></a>
          </div>
              </div>
            </div>
          </div>
    ...
    <div class="container" style="width: 100%">
     	<div class="row">
          ...
          <!--   <div class="col-md-3 col-sm-12 leftalign">
                ...
                <div class="templatemo_address">f
                	<ul>
    ...
    <div class="templatemo_footer">
      <div class="container">
      <div class="row">
          <div class="col-md-9 col-sm-12"> &copy; Excelsior 2015  
           </div>
            <div class="col-md-3 col-sm-12 templatemo_rfooter">
                <a href="https://www.facebook.com/excelsior.uiet" target=_blank>
                  <div class="hex_footer">
          <span class="fa fa-facebook"></span>
          </div>
                  </a>
                  <a href="https://www.twitter.com/excelsior_uiet" target=_blank>
                    <div class="hex_footer">
           <span class="fa fa-twitter"></span>
          </div>
                    </a>
                  <a href="https://www.instagram.com/excelsior.uietkuk" target=_blank>
                  <div class="hex_footer">
           <span class="fa fa-instagram"></span>
          </div>
                 </a>
				 <a href="https://www.youtube.com/channel/UC-Fh2ulGxbrv1uqeOY62m2A" target=_blank>
                    <div class="hex_footer">
